...
const locationController = createReferenceDataController({
  // Model name in Prisma
  modelName: 'ref_location',

  // Entity display name
  entityName: 'Location',

  // Property name that contains records in the response
  responsePropName: 'locations',
...
export const GET = locationController.GET;
export const POST = locationController.POST;
export const PUT = locationController.PUT;
export const DELETE = locationController.DELETE;
