...
export const GET = withUser(async (request: NextRequest) => {
  ...
  try {
    ...
    return createErrorResponse('Failed to fetch colors', HttpStatus.INTERNAL_SERVER_ERROR);
  }
});
...
export const POST = withUser(async (request: NextRequest) => {
  ...
  try {
    ...
    if (existingColor) {
      return createErrorResponse('Color already exists for this company', HttpStatus.CONFLICT);
    }
    ...
    return createErrorResponse('Failed to create color', HttpStatus.INTERNAL_SERVER_ERROR);
  }
});
...
export const PUT = withUser(async (request: NextRequest) => {
  ...
  try {
    ...
    if (!oldColor || !newColor) {
      return createErrorResponse('Both oldColor and newColor are required', HttpStatus.BAD_REQUEST);
    }
    ...
    if (!existingColor) {
      return createErrorResponse('Color does not exist', HttpStatus.NOT_FOUND);
    }
    ...
    return createErrorResponse('Failed to update color', HttpStatus.INTERNAL_SERVER_ERROR);
  }
});
...
export const DELETE = withUser(async (request: NextRequest) => {
  ...
  try {
    ...
    if (!color) {
      return createErrorResponse('Color parameter is required', HttpStatus.BAD_REQUEST);
    }
    ...
    return createErrorResponse('Failed to delete color', HttpStatus.INTERNAL_SERVER_ERROR);
  }
});
