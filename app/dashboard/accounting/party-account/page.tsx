      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              <label htmlFor="party-type" className="block text-sm font-medium text-gray-700 mb-1">Party Type</label>
              <select 
                id="party-type" 
            ...
            <div>
              <label htmlFor="party-name" className="block text-sm font-medium text-gray-700 mb-1">Party Name</label>
              <select 
                id="party-name" 
                className="w-full rounded-md border-gray-300 shadow-sm focus:border-maroon-500 focus:ring focus:ring-maroon-200 focus:ring-opacity-50"
              >
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr className="bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">$12,500.00</td>
              </tr>
              
              {/* Sample transactions */}
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Jan 5, 2025</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-maroon-600">PO-2025-1001</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Toyota Camry 2025 Purchase</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600">$24,500.00</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">$37,000.00</td>
              </tr>
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Jan 12, 2025</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-maroon-600">PAY-2025-052</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Payment to JDM Auto Trading</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600">$15,000.00</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">$22,000.00</td>
              </tr>
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Jan 18, 2025</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-maroon-600">PO-2025-1015</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Honda Accord 2025 Purchase</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600">$26,750.00</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">$48,750.00</td>
              </tr>
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Feb 2, 2025</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-maroon-600">PO-2025-1023</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Nissan Altima 2025 Purchase</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600">$22,500.00</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">$71,250.00</td>
              </tr>
              <tr>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Feb 10, 2025</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-maroon-600">PAY-2025-078</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Payment to JDM Auto Trading</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600">$25,000.00</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">$46,250.00</td>
              </tr>
              ...
              <tr className="bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Closing Balance</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">-</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">$98,250.00</td>
              </tr>
            </tbody>
          </table>
        </div>
