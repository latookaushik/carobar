        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Stock No</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              {[1, 2, 3, 4, 5].map((item) => (
                <tr key={item} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-maroon-600">ST-{10000 + item}</td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{2020 + item}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">White</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">JTDBE3{2020 + item}{100000 + item}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{12000 + (item * 5000)} km</td>
